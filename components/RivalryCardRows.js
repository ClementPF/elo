  ...
  render = () => {
    ...
    return (
      <View style={{ flex: 1, margin: 8 }}>
        <RivalryCardRow name={name1} value1={value1name1} value2={value2name1} />
        <RivalryCardRow name={name2} value1={value1name2} value2={value2name2} />
        <RivalryCardRow name={name3} value1={value1name3} value2={value2name3} />
        <RivalryCardRow name={name4} value1={value1name4} value2={value2name4} />
        <RivalryCardRow name={name5} value1={value1name5} value2={value2name5} />
      </View>
    );
  };
}
